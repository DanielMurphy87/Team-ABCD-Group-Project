  ...
  <div className='page'>
    ...
    <div className="about">
      ...
      <p className="about__paragraph">
        ...
        difficult to decide on a homemade meal or find inspiration to utilize
        the ingredients in your pantry. Additionally, mixing up a delicious
        drink can be a fun challenge. Fortunately, the "What's for Dinner" app
        is here to assist you in resolving these predicaments. It is your
      ...
      <p className="about__paragraph ">
        ...
        is user-friendly and intuitive, so you can easily navigate it and find
        what you're looking for. We also add new recipes regularly, so you never
