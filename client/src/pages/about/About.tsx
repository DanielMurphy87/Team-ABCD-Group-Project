...
const About:React.FC = () => 
  <>
   ...
   <div>
     ...
     <p> Are you ever unsure about what to prepare for your meals? It can be
      ...
      <p> What's for Dinner is a user-friendly app designed to make meal planning
     ...
     <p>Our app was developed by the great developement team ABCD.</p>
      
     <p> Our team is responsible for creating and maintaining the app, ensuring
        ...
        <p> In addition, we are always open to feedback and suggestions from our
